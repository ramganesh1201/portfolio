...
export function CaseStudyOverview({ project }: { project: CaseStudyData }) {
  return (
    <section className="py-16 px-6 md:px-10 relative z-20 w-full max-w-5xl mx-auto border-t border-white/[0.05]">
      <FadeIn y={20}>
        <h2 className="text-[#D7E2EA] font-bold text-3xl md:text-4xl uppercase tracking-wider mb-12">Project Overview</h2>
      </FadeIn>
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 bg-white/[0.02] border border-white/[0.05] rounded-[30px] p-8 md:p-12 backdrop-blur-sm">
